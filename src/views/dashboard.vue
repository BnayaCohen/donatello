<template>
  ...
  <div class="dashboard-modal flex flex-column align-center">
    <div class="dash-modal-wrapper">
      <button class="trellicons trellicons-close-btn dashboard-close" @click="closeDashboard"></button>
      ...
      <section class="general-statistics flex justify-center">
        <div class="stats tasks flex row-reverse justify-between">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px" width="90" height="100" viewBox="0 0 340 255" style="
              enable-background: new 0 0 299.998 299.998;
              fill: #42526e;
              margin-block-end: 10px;
            " xml:space="preserve" class="align-self-end">
            <g>
              <g>
        ...
        <div class="stats small circle-bar flex flex-column">
          ...
          <div class="percent-container flex align-center justify-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 34 34" class="pos-absolute">
              <circle cx="16" cy="16" r="15.9155" class="in-progress-bar__background" />

              <circle cx="16" cy="16" r="15.9155" class="in-progress-bar__progress js-progress-bar"
        ...
        <div class="stats members flex row-reverse justify-between">
          <svg id="Capa_1" x="0px" y="0px" width="100" height="150" viewBox="10 0 540 300"
            style="enable-background: new 0 0 479.293 479.293; fill: #42526e" class="align-self-end">
            <g>
              <g>
        ...
        <div class="stats overdue flex justify-between">
          <div class="content flex row-reverse justify-between">
            <svg id="Capa_1" x="0px" y="0px" viewBox="0 0 70 70" style="fill: #42526e" height="100" width="85"
