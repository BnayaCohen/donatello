  ...
  <div class="detail-sidebar">
    <div class="pos-relative">
      ...
      <div class="sidebar-btns flex flex-column">
        ...
        <div class="sidebar-btn-container">
          <button class="sidebar-btn flex align-center click-active" @click="openPicker($event, 'dates')">
        ...
        <div class="sidebar-btn-container">
          <button v-show="!currCover.background" class="sidebar-btn flex align-center click-active"
