  ...
  <header class="main-layout">
    <nav class="flex justify-between board-header">
      ...
      <section class="board-options flex align-center justify-center">
        <input class="board-name-input clean-input btn-background" type="text" placeholder="Enter board name here..." />
        <button class="starred-btn btn-background starred"  @click="toggleStarBoard"><svg
...
export default {
  ...
  created(){
// if(!this.board.isStarred)
// this.board.isStarred=false
  },
  methods: {
    toggleStarBoard() {
