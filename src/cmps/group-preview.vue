    ...
    <div class="group-header flex">
      ...
      <button @click="togglePopup" class="group-options-btn">
        ...
        <div v-if="showPopup" class="popup">
          <h4>List actions</h4>
          <span @click.stop="togglePopup" class="close-popup-btn"><svg aria-hidden="true" focusable="false"
              data-prefix="fas" data-icon="xmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"
